...
namespace MulticastFunc
{
    ...
    {
        public static MulticastFunc<TArg1, TArg2, TArg3, TResult> operator +(MulticastFunc<TArg1, TArg2, TArg3, TResult>? a, MulticastFunc<TArg1, TArg2, TArg3, TResult> b)
        {
            if (b == null)
                return a!;
            if (a == null)
        ...
        public static MulticastFunc<TArg1, TArg2, TArg3, TResult> operator +(MulticastFunc<TArg1, TArg2, TArg3, TResult>? a, Func<TArg1, TArg2, TArg3, TResult> b)
        {
            if (b == null)
                return a!;
            if (a == null)
        ...
        public static implicit operator MulticastFunc<TArg1, TArg2, TArg3, TResult>(Func<TArg1, TArg2, TArg3, TResult> f) => new MulticastFunc<TArg1, TArg2, TArg3, TResult>(f.GetInvocationList());

        public static explicit operator Func<TArg1, TArg2, TArg3, TResult>(MulticastFunc<TArg1, TArg2, TArg3, TResult> m)
        {
        ...
        public Span<TResult> Invoke(TArg1 arg1, TArg2 arg2, TArg3 arg3, Span<TResult> buffer)
        {
