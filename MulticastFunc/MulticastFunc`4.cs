...
namespace MulticastFunc
{
    ...
    public sealed class MulticastFunc<TArg1, TArg2, TArg3, TArg4, TResult>
    {
            ...
            [AllowNull] MulticastFunc<TArg1, TArg2, TArg3, TArg4, TResult> m)
        {
            ...
            if (m.Count == 1 && m.delegates[0] is Func<TArg1, TArg2, TArg3, TArg4, TResult> f)
                return f;

            return (Func<TArg1, TArg2, TArg3, TArg4, TResult>)Delegate.Combine(m.delegates)!;
        }
        #endregion
        ...
        /// <inheritdoc cref="Invoke(TArg1, TArg2, TArg3, TArg4)"/>
        ...
        public TResult[] InvokeAll(TArg1 arg1, TArg2 arg2, TArg3 arg3, TArg4 arg4)
        {
            var results = new TResult[Count];
            FillBufferAndAggregateExceptions(arg1, arg2, arg3, arg4, results);
            return results;
        }

        /// <inheritdoc cref="InvokeAll(TArg1, TArg2, TArg3, TArg4)"/>
        public ReadOnlySpan<TResult> InvokeAll(TArg1 arg1, TArg2 arg2, TArg3 arg3, TArg4 arg4, Span<TResult> spanBuffer)
        {
            FillBufferAndAggregateExceptions(arg1, arg2, arg3, arg4, spanBuffer);
        ...
        private MulticastFunc<TArg1, TArg2, TArg3, TArg4, TResult>? Remove(Delegate[] functions)
        {
            ...
            if (ReferenceEquals(results, delegates))
                return this;
            // Some were removed
            return new MulticastFunc<TArg1, TArg2, TArg3, TArg4, TResult>(results);
        }
        ...
        private void FillBufferAndAggregateExceptions(TArg1 arg1, TArg2 arg2, TArg3 arg3, TArg4 arg4, Span<TResult> buffer)
        {
            var length = delegates.Length;
            if (buffer.Length < length)
                throw new ArgumentException("Buffer is too small", nameof(buffer));
