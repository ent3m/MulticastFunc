...
namespace MulticastFunc
{
    ...
    public sealed class MulticastFunc<TArg1, TArg2, TArg3, TArg4, TArg5, TResult>
    {
        #region Operators
            ...
            [AllowNull] MulticastFunc<TArg1, TArg2, TArg3, TArg4, TArg5, TResult> m)
        {
            ...
            if (m.Count == 1 && m.delegates[0] is Func<TArg1, TArg2, TArg3, TArg4, TArg5, TResult> f)
                return f;

            return (Func<TArg1, TArg2, TArg3, TArg4, TArg5, TResult>)Delegate.Combine(m.delegates)!;
        }
        #endregion
        ...
        public override bool Equals([NotNullWhen(true)] object? obj)
        {
            ...
            if (ReferenceEquals(this, obj))
                return true;
            if (!(obj is MulticastFunc<TArg1, TArg2, TArg3, TArg4, TArg5, TResult> m))
                return false;
        ...
        public TResult[] Invoke(TArg1 arg1, TArg2 arg2, TArg3 arg3, TArg4 arg4, TArg5 arg5)
        {
            ...
            FillBuffer(arg1, arg2, arg3, arg4, arg5, results);
            return results;
        }

        /// <inheritdoc cref="Invoke(TArg1, TArg2, TArg3, TArg4, TArg5)"/>
        public ReadOnlySpan<TResult> Invoke(TArg1 arg1, TArg2 arg2, TArg3 arg3, TArg4 arg4, TArg5 arg5, Span<TResult> spanBuffer)
        {
            var length = FillBuffer(arg1, arg2, arg3, arg4, arg5, spanBuffer);
            return spanBuffer[..length];
        }

        /// <inheritdoc cref="MulticastFunc{TResult}.InvokeAll()"/>
        public TResult[] InvokeAll(TArg1 arg1, TArg2 arg2, TArg3 arg3, TArg4 arg4, TArg5 arg5)
        {
            var results = new TResult[Count];
            FillBufferAndAggregateExceptions(arg1, arg2, arg3, arg4, arg5, results);
            return results;
        }

        /// <inheritdoc cref="InvokeAll(TArg1, TArg2, TArg3, TArg4, TArg5)"/>
        public ReadOnlySpan<TResult> InvokeAll(TArg1 arg1, TArg2 arg2, TArg3 arg3, TArg4 arg4, TArg5 arg5, Span<TResult> spanBuffer)
        {
            FillBufferAndAggregateExceptions(arg1, arg2, arg3, arg4, arg5, spanBuffer);
        ...
        private MulticastFunc<TArg1, TArg2, TArg3, TArg4, TArg5, TResult>? Remove(Delegate[] functions)
        {
            ...
            if (ReferenceEquals(results, delegates))
                return this;
            // Some were removed
            return new MulticastFunc<TArg1, TArg2, TArg3, TArg4, TArg5, TResult>(results);
        }

        private int FillBuffer(TArg1 arg1, TArg2 arg2, TArg3 arg3, TArg4 arg4, TArg5 arg5, Span<TResult> buffer)
        {
        ...
        private void FillBufferAndAggregateExceptions(TArg1 arg1, TArg2 arg2, TArg3 arg3, TArg4 arg4, TArg5 arg5, Span<TResult> buffer)
        {
            var length = delegates.Length;
            if (buffer.Length < length)
                throw new ArgumentException("Buffer is too small", nameof(buffer));
