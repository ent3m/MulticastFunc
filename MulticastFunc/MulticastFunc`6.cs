...
namespace MulticastFunc
{
    public sealed class MulticastFunc<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TResult>
    {
            ...
            [AllowNull] MulticastFunc<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TResult> m)
        {
            ...
            Func<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TResult>? result = default;
            for (int i = 0; i < dels.Length; i++)
            {
                result += (Func<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TResult>)dels[i];
            }
            return result!;
        }
        ...
        public int Invoke(TArg1 arg1, TArg2 arg2, TArg3 arg3, TArg4 arg4, TArg5 arg5, TArg6 arg6, TResult[] buffer)
            => FillBuffer(arg1, arg2, arg3, arg4, arg5, arg6, buffer);
        ...
        private MulticastFunc<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TResult>? Remove(Delegate[] functions, bool canMutateFunctions)
        {
            var results = delegates.Remove(functions, canMutateFunctions);
            return results == null ? null : new MulticastFunc<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TResult>(results);
        }
