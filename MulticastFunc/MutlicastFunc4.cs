...
namespace MulticastFunc
{
    ...
    {
        readonly List<Func<T1, T2, T3, T4, TResult>> list = new List<Func<T1, T2, T3, T4, TResult>>();
        Action<T1, T2, T3, T4, TResult[]>? funcs;
        ...
        public static implicit operator MulticastFunc<T1, T2, T3, T4, TResult>(Func<T1, T2, T3, T4, TResult> f)
        {
            MulticastFunc<T1, T2, T3, T4, TResult> m = new MulticastFunc<T1, T2, T3, T4, TResult>();
            m.Add(f);
            return m;
        }
        ...
        {
            Func<T1, T2, T3, T4, TResult>? f = null;
            if (m == null)
                return f;
        ...
        public TResult[] Invoke(T1 arg1, T2 arg2, T3 arg3, T4 arg4)
        {
            ...
            funcs!.Invoke(arg1, arg2, arg3, arg4, results);
            return results;
        }
        ...
        private void Add(Func<T1, T2, T3, T4, TResult> func)
        {
            ...
            {
                var f = (Func<T1, T2, T3, T4, TResult>)function;
                list.Add(f);
                int j = list.Count - 1;
                funcs += (a1, a2, a3, a4, x) => x[j] = f(a1, a2, a3, a4);
            }
        }
        ...
        private void Remove(Func<T1, T2, T3, T4, TResult> func)
        {
            ...
            {
                int j = i;
                funcs += (a1, a2, a3, a4, x) => x[j] = list[j](a1, a2, a3, a4);
            }
        }
